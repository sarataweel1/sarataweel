        ...
        <div class="main-content">
                ...
                <div class="container1">
                    ...
                    <form method="POST" id="commentForm">
                        <div class="form-group1">
                            <input type="text" name="name" id="name" style="width:600px; margin-bottom:3px"
                                class="form-control" placeholder="Enter Name" required />
                        </div>
                        <div class="form-group1">
                            <textarea name="comment" id="comment" style="width:600px; margin-bottom:3px"
                                class="form-control" placeholder="Enter Comment" rows="5" required></textarea>
                        </div>
                        <span id="message"></span>
                        <div class="form-group1">
                            <input type="hidden" name="commentId" id="commentId" value="0" />
                            <input type="submit" name="submit" id="submit" class="btn btn-primary"
                                value="Post Comment" <?php include("../php/comments.php");?> />
                        </div>
                        <?php include("../php/show-comment.php");?>
                    </form>
            ...
            <div class="post-container">
                ...
                <div class="container1">
                    ...
                    <form method="POST" id="commentForm">
                        <div class="form-group1">
                            <input type="text" name="name" style="width:600px; margin-bottom:3px" id="name"
                                class="form-control" placeholder="Enter Name" required />
                        </div>
                        <div class="form-group1">
                            <textarea name="comment" id="comment" style="width:600px; margin-bottom:3px"
